    ...
    <div class="col-lg-12 col-md-12">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('viewMailable', ['name' => $name]) }}">{{ $name }}</a>
                </li>
            ...
            <div class="row my-4">
                    ...
                    <div id="accordion">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                    <p style="font-size: .9em;"><b class="font-weight-sixhundred">Mailable:</b> <a
                                            href="{{ route('viewMailable', ['name' => $name]) }}">{{ $name }}</a>
                                    </p>
                                    <p style="font-size: .9em;"><b class="font-weight-sixhundred">Namespace:</b>
                                        {{ $templateData['namespace'] }}</p>
                                    <p style="font-size: .9em;"><b
                                            class="font-weight-sixhundred">{{ $templateData['is_markdown'] ? 'Markdown' : 'View' }}:</b>
                                        {{ $templateData['template_name'] }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-9 col-md-12">
                    <div class="card mb-2">
                        <div class="card-header p-3" style="border-bottom:1px solid #e7e7e7e6;">
                            ...
                            <button type="button" class="btn btn-info float-right mr-2 send-test"><svg fill="#fff"
                                    width="20" enable-background="new 0 0 24 24" viewBox="0 0 24 24"
                    ...
                    <div class="card">
                        ...
                        <ul class="nav nav-pills" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $templateData['text_template'] !== null ? '' : 'disabled' }}"
                                    ...
                                    @foreach ($templateData['view_data'] as $param)
                                        ...
                                        @elseif(isset($param['data']['type']) && $param['data']['type'] === 'collection')
                                            <button type="button" class="btn btn-success btn-sm view_data_param"
                                                maileclipse-data-toggle="tooltip" data-placement="top" title="Collection"
                                                param-key="{{ $param['key'] }}">
                                                <i class="fa fa-table mr-1" aria-hidden="true"></i>{{ $param['key'] }}
                                            </button>
                                        @else
                                            <button type="button" class="btn btn-secondary btn-sm view_data_param"
                                                maileclipse-data-toggle="tooltip" data-placement="top"
                ...
                <div class="col-lg-3 d-none d-lg-block">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Mailable:</b> <a
                                    href="{{ route('viewMailable', ['name' => $name]) }}">{{ $name }}</a></p>
                            <p style="font-size: .9em;"><b class="font-weight-sixhundred">Namespace:</b>
                                {{ $templateData['namespace'] }}</p>
                            <p style="font-size: .9em;"><b
                                    class="font-weight-sixhundred">{{ $templateData['is_markdown'] ? 'Markdown' : 'View' }}:</b>
                    ...
                    $('.save-template').click(function() {
                        ...
                        notie.confirm({
                            ...
                            submitCallback: function() {
                                ...
                                localStorage.setItem(templateID, simplemde.codemirror
                                .getValue());
                                $('.save-draft').addClass('disabled').text('Draft Saved');

                                if (typeof plaintextEditor !== 'undefined' && plaintextEditor
                                    .getValue() !== '') {
                    ...
                    $('.save-template').click(function() {
                        ...
                        notie.confirm({
                            ...
                            submitCallback: function() {
                                ...
                                localStorage.setItem(templateID, tinymce.get('template_editor')
                                    .getContent());
                                $('.save-draft').addClass('disabled').text('Draft Saved');
                                ...
                                axios.post('{{ route('parseTemplate') }}', {
                                        markdown: tinymce.get('template_editor')
                                        .getContent(),
                                        viewpath: "{{ base64_encode($templateData['view_path']) }}"
                                    })
